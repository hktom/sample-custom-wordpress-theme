...
;?>
   ...
   <div id="blog-section-2">
     ...
     <h1 class="px-0"> <?php echo get_the_title();?> </h1>
       <div class="row mt-5">
        <div class="col-lg-8 mt-3 col-12">
        <div class="row mb-5" id="infinite-scroll-container" post="post" category="1, 51">
<?php endwhile;endif;?>
        <?php  do_shortcode('[wp_list_post post_type="post" category="1, 51" per_page=10]');?>
        </div>
        </div>
         <!-- sidebar -->
         <div class="col-lg-3 offset-lg-1 px-lg-0 col-12 tandem-sidebar">
         <?php
